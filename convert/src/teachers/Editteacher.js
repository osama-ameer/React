...
export default class Edit extends Component {
    constructor(props) {
      ...
      onSubmit = (e) => {
        ...
        updateRef.set({
          ...
          this.props.history.push("/showteacher/"+this.props.match.params.id)
        })
        .catch((error) => {
  ...
  <div className="container">
    ...
    <span><Link to ="/createteacher">+ADD TEACHERS</Link></span>
    <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h4><Link to={`/showteacher/${this.state.key}`} class="btn btn-primary">TEACHERS DATA</Link></h4>
            <form onSubmit={this.onSubmit}>
              <div class="form-group">
                <label for="name">Teacher Name:</label>
                <input type="text" class="form-control" name="name" value={this.state.name} onChange={this.onChange} placeholder="Teacher name" />
              </div>
              <div class="form-group">
